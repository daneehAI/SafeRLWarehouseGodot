...
if is_cuda:
    ...
    print("CUDA pytorch detected, running pytorch on GPU!")
    device = 'cuda'
else:
    print("No CUDA pytorch detected, running pytorch on CPU!")
    device = 'cpu'
...
if args.resume_model_path is None:
    ...
    model = MaskablePPO.load(path_zip, env=env, tensorboard_log=args.experiment_dir, device=device)
